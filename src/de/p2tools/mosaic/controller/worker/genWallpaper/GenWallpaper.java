...
package de.p2tools.mosaic.controller.worker.genWallpaper;
    ...
    private class GenerateWallPaper implements Runnable {
        ...
        public synchronized void run() {
            ...
            try {
                ...
                if (background.equals(MosaicData.BACKGROUND.IMAGE.toString()) &&
...
//                final BufferedImage imgOut =  ImgFile.getBufferedImage(destWidth, destHeight, borderColor);
                ...
                } else if (background.equals(MosaicData.BACKGROUND.IMAGE.toString())) {
