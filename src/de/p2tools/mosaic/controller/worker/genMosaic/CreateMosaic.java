...
public class CreateMosaic implements Runnable {
    ...
    public CreateMosaic(MosaicData.THUMB_SRC thumbSrc, String srcImgStr, String destImgStr,
    ...
    private boolean createMosaicFromThumbs() {
        ...
        return createMosaicFromThumbs.create(listeners, genImgDataArrayList);
    }
    ...
    private void createMosaicFromSrcImg() {
        ...
        createMosaicFromSrcImage.create(listeners, genImgDataArrayList);
    }
