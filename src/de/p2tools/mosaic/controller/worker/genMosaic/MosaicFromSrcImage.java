...
public class MosaicFromSrcImage implements Runnable {
    private String src, dest;
    private ThumbCollection thumbCollection;
    private MosaicData mosaikData;
    ...
    public MosaicFromSrcImage(String src, String dest, ThumbCollection thumbCollection, MosaicData mosaikData, EventListenerList listeners) {
        this.src = src;
        this.dest = dest;
    ...
    public synchronized void run() {
        ...
        try {
            ...
            if (ProgData.saveMem) {
                genImgDataArrayList.stream().forEach(genImgData -> genMosaic(genImgData));
            } else {
                genImgDataArrayList.parallelStream().forEach(genImgData -> genMosaic(genImgData));
            }
    ...
    private void genMosaic(GenImgData genImgData) {
