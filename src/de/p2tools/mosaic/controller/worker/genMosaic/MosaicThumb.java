...
public class MosaicThumb implements Runnable {
    String src, dest;
    ThumbCollection thumbCollection;
    MosaicData mosaikData;
    ...
    public MosaicThumb(String src, String dest, ThumbCollection thumbCollection,
                       MosaicData mosaikData, EventListenerList listeners) {
        this.src = src;
        this.dest = dest;
