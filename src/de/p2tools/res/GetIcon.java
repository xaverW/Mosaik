...
public class GetIcon {
    ...
    private final static String PFAD_PROGRAMM = "/de/p2tools/res/programm/";
    private final static String PFAD_SENDER = "/de/p2tools/res/sender/";
    private final static String PFAD_RES = "/de/p2tools/res/";
