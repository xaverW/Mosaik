...
package de.p2tools.tools.update;
...
import de.p2tools.mLib.tools.StringFormatters;
...
public class ProgrammUpdateSuchen {
    ...
    private InputStream connectToServer() throws IOException {
        final URLConnection conn = new URL(Const.ADRESSE_MTPLAYER_VERSION).openConnection();
