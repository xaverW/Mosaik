...
public class GetFile {
    ...
    public static final String PFAD_PSET_LINUX = "/de/p2tools/tools/file/pset_linux.xml";
    public static final String PFAD_PSET_WINDOWS = "/de/p2tools/tools/file/pset_windows.xml";
    public static final String PFAD_PSET_MAC = "/de/p2tools/tools/file/pset_mac.xml";
    public static final String PFAD_HILFETEXT_PRGRAMME = "/de/p2tools/tools/file/hilfetext_pset.txt";
