...
import de.mtplayer.tools.filmListFilter.FilmlistBlackFilter;
...
public class FilmList extends SimpleListProperty<Film> {
    ...
    public synchronized void markDoublyUrl() {
        // doppelte Filme (URL) markieren
        // viele Filme sind bei mehreren Sendern vorhanden
        final HashSet<String> hash = new HashSet<>(size(), 1);
        ...
        Log.sysLog("Anzahl doppelte Filme: " + count);
        hash.clear();
    }
