...
public class NamesList {
    ...
    public void setObsAllSender(ObservableList<String> obsAllSender) {
        this.obsAllSender = obsAllSender;
    }
    ...
    public void setObsThemaForSelSender(ObservableList<String> obsThemaForSelSender) {
        this.obsThemaForSelSender = obsThemaForSelSender;
    }
    ...
    public void setObsSenderForAbos(ObservableList<String> obsSenderForAbos) {
        this.obsSenderForAbos = obsSenderForAbos;
    }
    ...
    public void setObsAllAbonames(ObservableList<String> obsAllAbonames) {
        this.obsAllAbonames = obsAllAbonames;
    }

    public ObservableList<String> getObsAbonamesForDownloads() {
        return obsAbonamesForDownloads;
    }

    public void setObsAbonamesForDownloads(ObservableList<String> obsAbonamesForDownloads) {
        this.obsAbonamesForDownloads = obsAbonamesForDownloads;
    }
}
