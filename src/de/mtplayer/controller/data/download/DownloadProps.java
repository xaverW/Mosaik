...
public class DownloadProps extends DownloadXml {
    ...
    private final ObjectProperty<Datum> filmDate = new SimpleObjectProperty<>(new Datum(0));
    ...
    private final BooleanProperty geo = new SimpleBooleanProperty(false);
    ...
    private final BooleanProperty spotlight = new SimpleBooleanProperty(false);
    ...
    public final Property[] properties = {nr, filmNr, aboName, sender, thema, titel,
            ...
            filmDate, zeit, dauer,
            hd, ut, geo, filmUrl, historyUrl, url, urlRtmp, urlSubtitle,
            ...
            art, source, zurueckgestellt, infodatei, spotlight, subtitle};


    public Datum getFilmDate() {
        return filmDate.get();
    }

    public ObjectProperty<Datum> filmDateProperty() {
        return filmDate;
    }

    public void setFilmDate(Datum filmDate) {
...
//    }
    ...
    public BooleanProperty geoProperty() {
        return geo;
    }
    ...
    public BooleanProperty spotlightProperty() {
        return spotlight;
    }
    ...
    public void setPropsFromXml() {
        ...
        setGeo(Boolean.parseBoolean(arr[DOWNLOAD_GEO]));
        ...
        setSpotlight(Boolean.parseBoolean(arr[DOWNLOAD_SPOTLIGHT]));
    ...
    public void setXmlFromProps() {
        ...
        arr[DOWNLOAD_GEO] = String.valueOf(isGeo());
        ...
        arr[DOWNLOAD_SPOTLIGHT] = String.valueOf(isSpotlight());
