...
import de.mtplayer.controller.starter.Start;
...
public final class Download extends DownloadProps {
    ...
    public Download(SetData pSet,
        ...
        if (aufloesung.isEmpty()) {
            setUrl(film.getUrlFuerAufloesung(pSet.getResolution()));
            setUrlRtmp(film.getUrlFlvstreamerFuerAufloesung(pSet.getResolution()));
        } else {
    ...
    public void setFilm(Film film) {
        ...
        setGeo(Boolean.parseBoolean(film.arr[FilmXml.FILM_GEO]));
    }
