...
public class SetProps extends SetXml {
    ...
    private BooleanProperty spotlight = new SimpleBooleanProperty(SystemInfo.isMacOSX());
    ...
    public void setPropsFromXml() {
        ...
        setSpotlight(Boolean.parseBoolean(arr[PROGRAMMSET_SPOTLIGHT]));
    ...
    public void setXmlFromProps() {
        ...
        arr[PROGRAMMSET_FARBE] = MTC.getColorToHex(color.getValue());
        ...
        arr[PROGRAMMSET_SPOTLIGHT] = String.valueOf(isSpotlight());
