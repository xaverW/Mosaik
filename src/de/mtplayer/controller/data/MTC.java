...
public class MTC {
    ...
    private MLConfigs mlConfigs = null;
    private String text = "";
    ...
    public MTC(MLConfigs mlConfigs, Color color, String text) {
    ...
    public MLConfigs getMlConfigs() {
        return mlConfigs;
    }

    public void setMlConfigs(MLConfigs mlConfigs) {
