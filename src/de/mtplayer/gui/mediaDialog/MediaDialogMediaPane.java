...
import de.mtplayer.gui.mediaDb.MediaDbData;
...
public class MediaDialogMediaPane extends ScrollPane {
    ...
    public void make() {
        Listener.addListener(new Listener(Listener.EREIGNIS_MEDIA_DB_START, MediaDialogMediaPane.class.getSimpleName()) {
            @Override
            public void ping() {
            }
        });
        Listener.addListener(new Listener(Listener.EREIGNIS_MEDIA_DB_STOP, MediaDialogMediaPane.class.getSimpleName()) {
            @Override
            public void ping() {
                filter();
            }
