...
public class FilmFilterController extends FilterController {
    ...
    private void initStringFiter() {
        ...
        cbxSender.valueProperty().addListener((observable, oldValue, newValue) -> {
            if (oldValue != null && newValue != null) {
                ...
                if (newValue.isEmpty()) {
                    daten.namesList.getThemen("");
                } else {
                    daten.namesList.getThemen(newValue);
                }
            }
        });
        ...
        cbxSender.setItems(daten.namesList.getObsAllSender());
        cbxTheme.setItems(daten.namesList.getObsThemaForSelSender());
    ...
    private void initCheckFilter() {
        ...
        checkNot.getItems().addAll(NOT_ABO, NOT_HISTORY, NOT_DOUBLE);
