...
import de.mtplayer.controller.data.ProgData;
import de.mtplayer.controller.data.SetData;
import de.mtplayer.controller.data.SetList;
import de.mtplayer.controller.starter.RuntimeExec;
        ...
        try {
            switch (getOs()) {
                case LINUX:
                    ...
                    break;
                case MAC:
                    pfad = ProgInfos.getPathJar() + PFAD_MAC_FLV;
                    break;
                default:
        ...
        try {
            switch (getOs()) {
                case LINUX:
                    ...
                    break;
                case MAC:
                    pfad = ProgInfos.getPathJar() + PFAD_MAC_FFMPEG;
                    break;
                default:
