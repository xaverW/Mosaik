...
import de.mtplayer.controller.data.download.DownloadInfos;
import de.mtplayer.controller.data.download.DownloadSizeData;
...
public class TableDownload {
    ...
    public static TableColumn[] initDownloadColumn(TableView table) {
        ...
        final TableColumn<Download, Datum> datumColumn = new TableColumn<>("Datum");
    ...
    private static Callback<TableColumn<Download, Integer>, TableCell<Download, Integer>> cellFactoryStart
    ...
    private static void setCellStyle(TableCell<Download, Integer> cell, Integer item) {
    ...
    private static Callback<TableColumn<Download, Integer>, TableCell<Download, Integer>> cellFactoryNr
            = (final TableColumn<Download, Integer> param) -> {
    ...
    private static Callback<TableColumn<Download, Integer>, TableCell<Download, Integer>> cellFactoryFilmNr
            = (final TableColumn<Download, Integer> param) -> {
    ...
    private static Callback<TableColumn<Download, Double>, TableCell<Download, Double>> cellFactoryProgress
