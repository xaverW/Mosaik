...
import de.mtplayer.gui.dialog.DownloadEditDialogController;
...
public class DownloadGuiController extends AnchorPane {
    ...
    private void setfilter() {
        ...
        filteredDownloads.setPredicate(s -> (!s.isZurueckgestellt() &&
                sender.isEmpty() ? true : s.getSender().equals(sender)) &&
                (abo.isEmpty() ? true : s.getAboName().equals(abo)) &&
                (/*DownloadInfos.SRC_ALL=""*/ quelle.isEmpty() ? true : s.getSource().equals(quelle)) &&
                (/*DownloadInfos.ART_ALL=""*/ art.isEmpty() ? true : s.getArt().equals(art)));
