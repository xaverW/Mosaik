...
import de.mtplayer.tools.file.GetFile;
...
public class ResetDialogController extends MTDialog {
    ...
    public void make() {
        ...
        // Set zurücksetzen
        BigButton cancelButton = new BigButton("Nichts ändern", "");
        ...
        BigButton setButton = new BigButton("Einstellungen zum Abspielen/Aufzeichnen zurücksetzen",
        ...
        // alle Einstellungen
        BigButton allButton = new BigButton("Alle Einstellungen zurücksetzen!",
