...
public class MLInputStream extends InputStream {
    ...
    public String toString() {
        ...
        return "Download: Bytes gelesen: " + s + "  Bandbreite: " + SizeTools.humanReadableBandwidth(b);
    }
    ...
    public String[] getMsg() {
        ...
        final long b = getSumBandwidth();
        final String s = SizeTools.humanReadableByteCount(bytesRead, true);
        return new String[]{"Download", "Bytes gelesen: " + s, "Bandbreite: " + SizeTools.humanReadableBandwidth(b)};
    }
