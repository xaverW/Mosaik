...
public class GetIcon {
    ...
    private final static String PFAD_PROGRAMM = "/de/mtplayer/res/programm/";
    private final static String PFAD_SENDER = "/de/mtplayer/res/sender/";
    private final static String PFAD_RES = "/de/mtplayer/res/";
