...
public class MosaikErstellen_ {
    ...
    public MosaikErstellen_(Daten ddaten) {
        daten = ddaten;
    }
    /////////////////////////////////////////
    // public
    ...
    private class Tus implements Runnable {
        ...
        public synchronized void run() {
            ...
            if (dest.equals("")) {
                ...
                if (weiter && len > 0) {
                    ...
                    Farbraum_ farbraum = new Farbraum_(daten);
                    File file;
                    ...
                    for (int yy = 0; yy < anzH && !stopAll; ++yy) {
                        for (int xx = 0; xx < anzW && !stopAll; ++xx) {
                            ...
                            if (farbe != null) {
                                ...
                                daten.fehler.fehlermeldung("MosaikErstellen_.tus-Farbe fehlt!!");
                            }
                        }
                    }
                    //fertig
        ...
        private void writeImage(BufferedImage img) {
            ...
            try {
                ...
                daten.fehler.fehlermeldung(e, "MosaikErstellen_.Tus.writeImage");
            } finally {
                try {
                    ios.close();
                    writer.dispose();
