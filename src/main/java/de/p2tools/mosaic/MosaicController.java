...
public class MosaicController extends StackPane {
    ...
    Button btnThumbNail = new Button("Miniaturbilder " + P2LibConst.LINE_SEPARATOR + "erstellen");
    Button btnMosaic = new Button("Mosaik " + P2LibConst.LINE_SEPARATOR + "erstellen");
