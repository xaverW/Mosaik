...
public class GuiMosaicPane extends AnchorPane {
    ...
    public void isShown() {
        ...
        if (cbDestDir.getSelValue().isEmpty()) {
            ...
            Path p = Paths.get(progData.selectedProjectData.getDestDir(),
                    PFileName.getNextFileNameWithNo(progData.selectedProjectData.getDestDir(),
    ...
    private void initCont() {
        // SRC
        btnSrc.setOnAction(event -> PDirFileChooser.FileChooser(ProgData.getInstance().primaryStage,
                cbSrcPhoto,
        ...
        // DEST
        btnDest.setOnAction(event -> PDirFileChooser.FileChooserSave(ProgData.getInstance().primaryStage, cbDestDir,
                progData.selectedProjectData.getDestDir(),
                "Mosaik.jpg"));
        ...
        btnHelpDest.setOnAction(a -> new PAlert().showHelpAlert("Mosaik", HelpText.MOSAIC_DEST));


        // Thumbsize
        final Button btnHelpSlider = new Button("");
        btnHelpSlider.setGraphic(new Icons().ICON_BUTTON_HELP);
        btnHelpSlider.setOnAction(a -> new PAlert().showHelpAlert("Pixel", HelpText.MOSAIC_PIXEL_SIZE));
